...
export const translations = {
  en: {
    ...
    defaultPositionPrefix: 'Position',
    ...
    shortName: 'Short name (for scoreboard)',
    shortNamePlaceholder: 'e.g. Panthers',
    rivalShortName: 'Short name for scoreboard',
    rivalShortNamePlaceholder: 'e.g. Fuenlabrada',
    creating: 'Creating...',
    create: 'Create',
    ...
    editorLinkDesc: 'Editors can track games, edit roster & manage team',
    viewerLinkDesc: 'Viewers can see everything but cannot make changes',
    teamMembers: 'Team members',
    changeRole: 'Change role',
    removeMember: 'Remove',
    confirmRemoveMember: (email) => `Remove ${email} from the team?`,
    you: '(You)',
    viewOnly: 'View only',
    viewerNotice: "You have viewer access. You can see everything but can't make changes.",
    ...
    substitutions: 'Subs',
    leadChangesLabel: 'Lead chg.',
    tiesLabel: 'Ties',
    biggestLeadLabel: 'Biggest lead',
    parcialsTitle: 'Parcials by Quarter',
    total: 'Total',
    playerStatsTitle: 'Player Stats',
    quintetsPM: 'Lineups by +/-',
    quintetsOffense: 'Best Offensive Lineups',
    quintetsDefense: 'Best Defensive Lineups',
    quintetsShooting: 'Lineups by Shooting %',
    quintets3PT: 'Best 3PT Lineups',
    quintetsMinutes: 'Lineups by Minutes',
    bestWorstStints: 'Best & Worst Stints',
    foulImpactTitle: 'Player Impact',
    stintsDetail: 'Player Stints',
    bestStintLabel: 'Best stint',
    worstStintLabel: 'Worst stint',
    noData: 'No data',
    scored: 'scored',
    allowed: 'allowed',
    topStints: 'Top 5 Best Stints',
    bottomStints: 'Top 5 Worst Stints',
    player: 'Player',
    onCourtPM: 'On +/-',
    offCourtPM: 'Off +/-',
    impactExplanation: 'Score change when this player is on court vs off court',

    // Trash / Recycle bin
    trash: 'Trash',
    restore: 'Restore',
    deletePermanently: 'Delete permanently',
    deleteGamePermanentMsg: 'This game will be permanently deleted. This action cannot be undone.',
    deletedDaysAgo: (days) => days === 0 ? 'Deleted today' : `Deleted ${days}d ago`,
    autoDeleteWarning: 'Games are auto-deleted after 7 days',
    moveToTrash: 'Move to trash',
    moveToTrashMsg: 'This game will be moved to the trash. You can restore it within 7 days.',

    // Season Stats
    seasonStatsTab: 'Stats',
    seasonSummary: 'Season Summary',
    seasonPlayerStats: 'Player Stats',
    seasonStintAnalysis: 'Stint Analysis',
    seasonBestLineups: 'Best Lineups',
    seasonPlayerImpact: 'Player Impact',
    seasonWins: 'W',
    seasonLosses: 'L',
    seasonDraws: 'D',
    seasonAvgScored: 'Avg scored',
    seasonAvgAllowed: 'Avg allowed',
    seasonAvgDiff: 'Avg +/-',
    seasonGamesPlayed: 'games',
    seasonAvgSubs: 'avg subs',
    seasonGP: 'GP',
    seasonMPG: 'MPG',
    seasonPPG: 'PPG',
    seasonFPG: 'FPG',
    seasonTotalPts: 'Total pts',
    ...
    seasonDefense: 'DEF',
    seasonMinutes: 'MIN',
    seasonNoData: 'No completed games yet',
    seasonNoDataHint: 'Stats will appear after finishing your first game',
  ...
  es: {
    ...
    defaultPositionPrefix: 'Posición',
    ...
    shortName: 'Nombre corto (para el marcador)',
    shortNamePlaceholder: 'Ej: Panteras',
    rivalShortName: 'Nombre corto para el marcador',
    rivalShortNamePlaceholder: 'Ej: Fuenlabrada',
    creating: 'Creando...',
    create: 'Crear',
    ...
    editor: 'Editor',
    viewer: 'Espectador',
    editorAccess: 'Acceso de edición',
    viewerAccess: 'Acceso de visualización',
    editorLinkDesc: 'Los editores pueden trackear partidos, editar plantilla y gestionar equipo',
    viewerLinkDesc: 'Los espectadores pueden ver todo pero no pueden hacer cambios',
    teamMembers: 'Miembros del equipo',
    changeRole: 'Cambiar rol',
    removeMember: 'Quitar',
    confirmRemoveMember: (email) => `¿Quitar a ${email} del equipo?`,
    you: '(Tú)',
    viewOnly: 'Solo lectura',
    viewerNotice: 'Tienes acceso de visualización. Puedes ver todo pero no puedes hacer cambios.',
    ...
    leadChangesLabel: 'Cambios líder',
    tiesLabel: 'Empates',
    biggestLeadLabel: 'Mayor ventaja',
    parcialsTitle: 'Parciales por Cuarto',
    total: 'Total',
    playerStatsTitle: 'Stats Individuales',
    quintetsPM: 'Quintetos por +/-',
    quintetsOffense: 'Mejores Quintetos Ofensivos',
    quintetsDefense: 'Mejores Quintetos Defensivos',
    quintetsShooting: 'Quintetos por % de Tiro',
    quintets3PT: 'Mejores Quintetos por 3PT',
    quintetsMinutes: 'Quintetos por Minutos',
    bestWorstStints: 'Mejores y Peores Stints',
    foulImpactTitle: 'Impacto de Jugador',
    stintsDetail: 'Stints por Jugador',
    bestStintLabel: 'Mejor stint',
    worstStintLabel: 'Peor stint',
    noData: 'Sin datos',
    scored: 'anotados',
    allowed: 'recibidos',
    topStints: 'Top 5 Mejores Stints',
    bottomStints: 'Top 5 Peores Stints',
    player: 'Jugador',
    onCourtPM: 'En +/-',
    offCourtPM: 'Fuera +/-',
    impactExplanation: 'Cambio en el marcador cuando este jugador está en pista vs fuera de pista',

    // Trash / Recycle bin
    trash: 'Papelera',
    restore: 'Restaurar',
    deletePermanently: 'Eliminar definitivamente',
    deleteGamePermanentMsg: 'Este partido se eliminará definitivamente. Esta acción no se puede deshacer.',
    deletedDaysAgo: (days) => days === 0 ? 'Eliminado hoy' : `Eliminado hace ${days}d`,
    autoDeleteWarning: 'Los partidos se eliminan automáticamente tras 7 días',
    moveToTrash: 'Mover a papelera',
    moveToTrashMsg: 'Este partido irá a la papelera. Podrás restaurarlo en los próximos 7 días.',

    // Season Stats
    seasonStatsTab: 'Stats',
    seasonSummary: 'Resumen de Temporada',
    seasonPlayerStats: 'Stats de Jugadores',
    seasonStintAnalysis: 'Análisis de Stints',
    seasonBestLineups: 'Mejores Quintetos',
    seasonPlayerImpact: 'Impacto de Jugador',
    seasonWins: 'V',
    seasonLosses: 'D',
    seasonDraws: 'E',
    seasonAvgScored: 'Media anotada',
    seasonAvgAllowed: 'Media recibida',
    seasonAvgDiff: 'Media +/-',
    seasonGamesPlayed: 'partidos',
    seasonAvgSubs: 'cambios/partido',
    seasonGP: 'PJ',
    seasonMPG: 'MPP',
    seasonPPG: 'PPP',
    seasonFPG: 'FPP',
    seasonTotalPts: 'Pts totales',
    ...
    seasonDefense: 'DEF',
    seasonMinutes: 'MIN',
    seasonNoData: 'No hay partidos finalizados',
    seasonNoDataHint: 'Las estadísticas aparecerán al finalizar tu primer partido',
